...
export class Css3Renderer {
  constructor() {
    ...
    this._defaultCameraElement = this.addCamera(
...
export class Css3Plane {
  ...
  constructor(dom, entity, pixelsPerWorldUnit, camera) {
    ...
    this.pixelsPerWorldUnit = new pc.Vec2(
      pixelsPerWorldUnit,
      pixelsPerWorldUnit
    );
  ...
  updateTransform() {
    ...
    const height = Math.min(
      scale.z * this.pixelsPerWorldUnit.y,
      this._maxHeight
    );
...
// // Wrapper function to extend PlayCanvas with CSS3 capabilities
// export function extendPlayCanvasCss3(pcModule) {
//   // Epsilon function to handle near-zero values
//   const epsilon = (value) => {
//     return Math.abs(value) < 1e-10 ? 0 : value;
//   };

//   // Camera CSS Matrix generation
//   const getCameraCSSMatrix = (matrix) => {
//     const elements = matrix.data;
//     return (
//       "matrix3d(" +
...
//   class Css3Renderer {
//     constructor() {
//       const app = pcModule.Application.getApplication();
...
//       this._defaultCameraElement = null;
//       this._css3Targets = [];
//       this._cameraInvertMat = new pcModule.Mat4();
//       this._cameraHalfSize = new pcModule.Vec2();

//       // Defer DOM manipulation until we're sure elements exist
...
//           if (!canvas) {
//             console.warn(
//               "Canvas not found, deferring CSS3 renderer initialization"
//             );
//             return;
//           }
...
//           canvas.parentNode.insertBefore(stageElement, canvas);

//           // Insert stage element before or after canvas based on parent
//           // const canvasParent = canvas.parentNode;
//           // if (canvasParent) {
//           //   canvasParent.insertBefore(stageElement, canvas.nextSibling);
//           // } else {
//           //   document.body.appendChild(stageElement);
//           // }
...
//         } catch (error) {
//           console.error("Error initializing CSS3 Renderer:", error);
//         }
//       }, 0);
//     }
...
//         this._stageElement.style.width = this._width + "px";
//         this._stageElement.style.height = this._height + "px";

//         for (let i = 0; i < this._cameraElements.length; i++) {
//           if (this._cameraElements[i]) {
//             this._cameraElements[i].style.width = this._width + "px";
//             this._cameraElements[i].style.height = this._height + "px";
//           }
//         }
//       };
...
//     removeTarget(target) {
//       const index = this._css3Targets.indexOf(target);
//       if (index !== -1) this._css3Targets.splice(index, 1);
//     }

//     blockEvents(state) {
//       for (
//         let i = 0;
//         i < this._css3Targets.length;
//         this._css3Targets[i++].blockEvents(state)
//       );
//     }
...
//         if (camera.projection == pcModule.PROJECTION_PERSPECTIVE) {
//           this._stageElement.style.WebkitPerspective = fov + "px";
//           this._stageElement.style.perspective = fov + "px";
//         } else {
//           this._stageElement.style.WebkitPerspective = "";
...
//         if (camera.projection == pcModule.PROJECTION_ORTHOGRAPHIC) {
//           pcModule.Mat4._getPerspectiveHalfSize(
//             this._cameraHalfSize,
//             camera.fov,
//             camera.aspectRatio,
//             camera.nearClip,
...
//         this._cameraInvertMat.copy(camera.entity.getWorldTransform()).invert();
//         cameraCSSMatrix =
//           camera.projection == pcModule.PROJECTION_ORTHOGRAPHIC
//             ? "scale(" +
//               fov +
//               ")" +
//               "translate(" +
...
//       setTimeout(() => {
//         if (!this._renderer._stageElement) {
//           console.warn(
//             "Stage element not ready, deferring Css3Plane initialization"
//           );
//           return;
//         }
...
//         this._maxHeight = 1080;
//         pixelsPerWorldUnit = pixelsPerWorldUnit || this._maxWidth;
//         this.pixelsPerWorldUnit = new pcModule.Vec2(
//           pixelsPerWorldUnit,
//           pixelsPerWorldUnit
//         );
...
//         scale.x * this.pixelsPerWorldUnit.x,
//         this._maxWidth
//       );
//       const height = Math.min(
//         scale.z * this.pixelsPerWorldUnit.y,
...
//   // Extend the PlayCanvas module with new classes
//   // pcModule.Css3Renderer = Css3Renderer;
//   // pcModule.Css3Plane = Css3Plane;
...
// // Export a function to extend PlayCanvas with CSS3 capabilities
// export function initializeCss3Extensions(pcModule) {
//   // return extendPlayCanvasCss3(pcModule);
//   const { Css3Renderer, Css3Plane } = extendPlayCanvasCss3(pcModule);
//   return {
//     ...pcModule,
//     Css3Plane,
//     Css3Renderer,
